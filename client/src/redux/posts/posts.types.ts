export const PostsActionTypes = {
  ...
  ADD_COMMENT_LIKE_START: 'ADD_COMMENT_LIKE_START',
  ADD_COMMENT_LIKE_SUCCESS: 'ADD_COMMENT_LIKE_SUCCESS',

  REMOVE_COMMENT_LIKE_START: 'REMOVE_COMMENT_LIKE_START',
  REMOVE_COMMENT_LIKE_SUCCESS: 'REMOVE_COMMENT_LIKE_SUCCESS',
};
